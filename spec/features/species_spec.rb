RSpec.feature 'Species', type: :feature do
  ...
  scenario 'Create species article' do
    ...
    fill_in 'Write the url of the images(http://www.imageexmaple.com)',
            with: 'https://vignette.wikia.nocookie.net/colombia/images/0/0b/Vultur-gryphus_gif.jpg/revision/latest/scale-to-width-down/340?cb=20120901014330&path-prefix=es'
